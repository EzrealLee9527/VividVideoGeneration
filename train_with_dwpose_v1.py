...
def main(
    ...
    *_, config = inspect.getargvalues(inspect.currentframe())
    ...
    det_config = 'controlnet_aux/src/controlnet_aux/dwpose/yolox_config/yolox_l_8xb8-300e_coco.py'
    det_ckpt = '/models00/controlnet_aux/yolox_l_8x8_300e_coco_20211126_140236-d3bd2b23.pth'
    pose_config = 'controlnet_aux/src/controlnet_aux/dwpose/dwpose_config/dwpose-l_384x288.py'
    ...
    for epoch in range(first_epoch, num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            model_pred = model(init_latents=noisy_latents,
                               ...
                               timestep=timesteps,
                               source_image=pixel_values_ref_img,  # FIXME: only support train_batch_size=1
            ...
            if is_main_process and (global_step % validation_steps == 0 or global_step in validation_steps_tuple):
                ...
                for idx, prompt in enumerate(prompts):
                    ...
                    encoder_hidden_states_val = encoder_hidden_states
                    sample = model.infer(
