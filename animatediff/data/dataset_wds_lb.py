...
def get_dataloader(config: DictConfig) -> wds.WebLoader:
    ...
    dataset = wds.DataPipeline(
        ...
        wds.batched(config.train.batch_size, collation_fn=None, partial=False),
    )
...
data_config = {
    "root_dirs":["s3://ljj/Datasets/Videos/processed/CelebV_webdataset_20231211_videoblip"],
    "num_workers":8,
    "size":512,
    "frame_stride":2,
    "cache_dir":"/data/cache",
    "cache_size_in_gb":500,
    "num_frames":14,
    "vae_scale_factor":8,
}
