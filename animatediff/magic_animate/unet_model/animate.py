...
from animatediff.magic_animate.unet_model.appearance_encoder import AppearanceEncoderModel
...
from animatediff.magic_animate.unet_model.resnet import InflatedConv3d
from animatediff.magic_animate.unet_model.resampler import Resampler, MLPProjModel
...
class MagicAnimate(torch.nn.Module):
    def __init__(self,
        ...
        *_, func_args = inspect.getargvalues(inspect.currentframe())
        ...
        if "use_image_encoder" in config.keys() and config['use_image_encoder']:
        ...
        from animatediff.magic_animate.unet_model.pipeline import AnimationPipeline as TrainPipeline
