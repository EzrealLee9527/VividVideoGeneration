...
class AnimationPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        controlnet_text_embeddings = text_embeddings.repeat_interleave(
            video_length, 0)
        print('controlnet_text_embeddings', controlnet_text_embeddings.shape)
    ...
    def train(
        ...
        reference_control_writer = ReferenceAttentionControl(appearance_encoder, do_classifier_free_guidance=False,
                                                             mode='write', batch_size=batch_size, clip_length=context_frames)
        reference_control_reader = ReferenceAttentionControl(self.unet, do_classifier_free_guidance=False, mode='read',
                                                             batch_size=batch_size, clip_length=context_frames)
